...
def initialize_database():
    ...
    with app.app_context(): # Operations need to be within an application context
        ...
        inventory_data = [
            {'name': 'Agar Plate', 'group': eye_group, 'location': 'P2C Fridge'},
            {'name': 'Bronchoscope (Pentax)', 'group': ent_group, 'location': 'Trolley + Briefcase + Top'},
            {'name': 'Flexible Scope (Olympus)', 'group': ent_group, 'location': 'Trolley + Briefcase + Top'},
            {'name': 'FB Remover Device', 'group': ent_group, 'location': 'Trolley + Briefcase + Top'},
            {'name': 'Light Source (Olympus)', 'group': ent_group, 'location': 'Trolley + Briefcase + Top'},
            {'name': 'Scope Battery Cable', 'group': ent_group, 'location': 'Trolley + Briefcase + Top'},
            {'name': 'Ear Forceps (145mm)', 'group': ent_group, 'location': 'Drawer 1', 'frequenty_used': True},
            {'name': 'Killian Nasal Speculum', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Laryngeal Mirror(K4/6/8/10)', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Hartman Forceps', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'West Dressing Forceps', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Ear Tampon Forceps', 'group': ent_group, 'location': 'Drawer 1', 'frequenty_used': True},
            {'name': 'Micro Forceps', 'group': ent_group, 'location': 'Drawer 1', 'frequenty_used': True},
            {'name': 'Jobson Probe', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Thudicum Nasal', 'group': ent_group, 'location': 'Drawer 2', 'frequenty_used': True},
            {'name': 'Tuning Fork (S)', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Tuning Fork (L)', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Tongue Depressor', 'group': ent_group, 'location': 'Drawer 2', 'frequenty_used': True},  
            {'name': 'Laryngeal Mirror', 'group': ent_group, 'location': 'Drawer 2'}, 
            {'name': 'Huber Handle', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Dental Suturing Set', 'group': dental_group, 'location': 'Top Cupboard', 'frequenty_used': True},
            {'name': 'I&D Set', 'group': dental_group, 'location': 'Top Cupboard'},
            {'name': 'E&D Set', 'group': dental_group, 'location': 'Top Cupboard'},
            {'name': 'Wiring Set', 'group': dental_group, 'location': 'Top Cupboard'},
            {'name': 'Tweezers', 'group': dental_group, 'location': 'Drawer 1'},
            {'name': 'Adult Cuved Root Forceps', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Dental Pliers', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Adult Special 8 Forceps', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Pedo Lower Anterior Forceps', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Pedo Upper Anterior Forceps', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Plastic Six', 'group': dental_group, 'location': 'Drawer 2'},
            {'name': 'Coupland 1,2,3 / sets', 'group': dental_group, 'location': 'Drawer 3'},
            {'name': 'Straight Warmick James', 'group': dental_group, 'location': 'Drawer 3'},
            {'name': 'Warmick James(Left/Right)', 'group': dental_group, 'location': 'Drawer 3'},
            {'name': 'Dental Mouth Gag', 'group': dental_group, 'location': 'Drawer 4'},
            {'name': 'Dental Bone Rouger', 'group': dental_group, 'location': 'Drawer 4'},
            {'name': 'Adult Upper Anterior Forceps', 'group': dental_group, 'location': 'Drawer 4'},
            {'name': 'Dental Syringes', 'group': dental_group, 'location': 'Drawer 4', 'frequenty_used': True},
            {'name': 'Dental Mirror', 'group': dental_group, 'location': 'Drawer 4'},
            {'name': 'Adult Upper Rt Molar Forceps', 'group': dental_group, 'location': 'Drawer 5'},
            {'name': 'Adult Upper Lt Molar Forceps', 'group': dental_group, 'location': 'Drawer 5'},
            {'name': 'Dental Handpiece', 'group': dental_group, 'location': 'Drawer 5'},
            {'name': 'Adult Upper Pre-Molar Forceps', 'group': dental_group, 'location': 'Drawer 5'},
            {'name': 'Adult Lower Anterior Forceps', 'group': dental_group, 'location': 'Drawer 5'},
            {'name': 'Dental Chair', 'notes': 'verified working', 'group': dental_group, 'location': 'Drawer 5'}
        ]
        ...
        for item_data in inventory_data:
            inventory_item = Inventory(
                ...
                frequently_used=item_data.get('frequenty_used', False)  
            )
        ...
        if shift_for_logs:
            ...
            shift_inventory_data = [
                ...
                {'item_name': 'Bronchoscope (Pentax)', 'quantity': 1},
                ...
                {'item_name': 'Laryngeal Mirror(K4/6/8/10)', 'quantity': 8},
                {'item_name': 'Hartman Forceps', 'quantity': 1},
                {'item_name': 'West Dressing Forceps', 'quantity': 5},
                {'item_name': 'Ear Tampon Forceps', 'quantity': 8},
                {'item_name': 'Micro Forceps', 'quantity': 6},
                {'item_name': 'Jobson Probe', 'quantity': 4},
                {'item_name': 'Thudicum Nasal', 'quantity': 5},
                {'item_name': 'Tuning Fork (S)', 'quantity': 1},
                {'item_name': 'Tuning Fork (L)', 'quantity': 1},
                {'item_name': 'Tongue Depressor', 'quantity': 9},
                {'item_name': 'Laryngeal Mirror', 'quantity': 1},
                {'item_name': 'Huber Handle', 'quantity': 1},
                {'item_name': 'Dental Syringes', 'quantity': 8},
