...
def initialize_database():
    ...
    with app.app_context(): # Operations need to be within an application context
        ...
        inventory_data = [
            ...
            {'name': 'Ear Forceps (145mm)', 'group': ent_group, 'location': 'Drawer 1'},
            ...
            {'name': 'Ear Tampon Forceps', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Micro Forceps', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Jobson Probe', 'group': ent_group, 'location': 'Drawer 1'},
            {'name': 'Thudicum Nasal', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Tuning Fork (S)', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Tuning Fork (L)', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Tongue Depressor', 'group': ent_group, 'location': 'Drawer 2'},  
            {'name': 'Laryngeal Mirror', 'group': ent_group, 'location': 'Drawer 2'}, 
            {'name': 'Huber Handle', 'group': ent_group, 'location': 'Drawer 2'},
            {'name': 'Dental Suturing Set', 'group': dental_group, 'location': 'Top Cupboard'},
            ...
            {'name': 'Dental Syringes', 'group': dental_group, 'location': 'Drawer 4'},
